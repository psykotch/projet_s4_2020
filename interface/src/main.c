...
int main(int argc, char *argv[])
{
    ...
    widgets->w_dlg_file_choose = GTK_WIDGET(gtk_builder_get_object(builder, "dig_file_choose"));
    widgets->w_img_main = GTK_WIDGET(gtk_builder_get_object(builder, "image_main"));
